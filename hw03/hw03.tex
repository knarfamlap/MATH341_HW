...
If $n=100$ and $\sum_{i=0}x_i = 39$, then let $\alpha = 0.5$ 

\begin{align*}
    \prob{\theta} &= Beta(2.5, 2.5) \\
    \prob{\theta | X} &= Beta(2.5 + 39, 2.5, + 100 - 39) \\ 
    &= Beta(41.5, 63.5) \\
\end{align*}
...
\begin{align*}
   ...
   &= 1 - \frac{\alpha + n}{\alpha+\beta+n} \\
   &= 1 - (\frac{41.5 + 5}{63.5 + 41.5 + 5}) \\
   &= 1 - 0.423 \\
   &= 0.577
\end{align*}
